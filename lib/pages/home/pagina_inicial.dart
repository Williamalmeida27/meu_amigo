...
class _PaginaInicialState extends State<PaginaInicial> {
  ...
  var cadastroRepository = getIt<CadastroRepository>();
  var _hojeRepository = getIt<HojeRepository>();
  ...
  void initState() {
    super.initState();
    // if (cadastroRepository.obterDados().) {
    //   print("Não tem dados");
    // } else {
    //   print("Tem dados");
    // }
        ...
        children: [
          Expanded(
              child: loading
                  ...
                  : ListView.builder(
                      itemCount: _dadosMeuAmigo.dadosCao.length,
                      itemBuilder: (BuildContext context, int index) {
                        var dado = _dadosMeuAmigo.dadosCao[index];
                        return Column(
                          children: [
                            SizedBox(
                    ...
                    child: loading
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (BuildContext, index) {
                              ...
                              return Dismissible(
                                key: Key(hoje?.objectId ?? ""),
                                onDismissed:
                                    (DismissDirection dismissDirection) async {
                                  await _hojeRepository
                                      .excluirTarefas(hoje!.objectId ?? "");
                                },
                                child: Row(
                                  mainAxisAlignment:
                        ...
                        TextButton(
                            onPressed: () async {
                              await HojeRepository().criarTarefa(
                                  Today.criar(descricaoController.text, false));
                              carregarDados();
                              Navigator.pop(context);
                            },
